...
import com.stock.mystock.common.jwt.*;
...
public class SecurityConfiguration {
    ...
    private final String[] PERMIT_ALL_ARRAY = { // 허용할 API
            "/","/user/signup", "/user/login","/**","/login/**", "/oauth2/**", "/user/token","/user/ws/**", "/user/oauth2/**"
    };
    ...
    private final String[] CORS_ALLOW_URL = { // 허용할 URL
            "http://localhost:5173", "http://localhost:3000","https://github.com" ,"https://stackup.live","https://stackup.live:443" , "https://stackup.live"
    };
